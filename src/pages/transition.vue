<template>
  <div class="container">
    ...
    <div class="mt-3 flex w-[50%] justify-between">

      <button  class="px-3 py-3 rounded-md text-white bg-orange-200" @click="notifySuccess">notifySuccess</button>
      <button  class="px-3 py-3 rounded-md text-white bg-orange-200" @click="notifyError">notifyError !</button>
    </div>
